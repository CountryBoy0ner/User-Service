...
class UserRepositoryIT {
    ...
    void findByEmail_success() {
        ...
        assertEquals(saved.getId(), userRepository.findByEmail("john@example.com").orElseThrow().getId());
    }
    ...
    void searchUsersByName_success() {
        ...
        assertEquals(2, result.size(), "should return only users whose name contains 'John'");
    ...
    void updateUserInfo_success() {
        ...
        int affected = userRepository.updateUserInfo(saved.getId(), "New", "Surname", "new@mail.com");
